...
/**
 * <b>Title:</b> ResponseDTOMessageListenerTest.java
 * <b>Project:</b> Notifications MicroService
 * <b>Description:</b> Unit Tests providing coverage for the ResponseDTOMessageListener Class
 *
 * <b>Copyright:</b> 2022
...
class RequestDTOMessageListenerTest {
	...
	String validSchema = "{\"$id\": \"https://nga.com/oe.human-feedback-core.schema.json\",\"$schema\": \"http://json-schema.org/draft-07/schema\","
			...
			+ "\"createdBy\": \"Ray McManemin\",\"createdFor\": \"HumanFeedback\","
			+ "    \"version\": \".01\","
			+ "    \"type\": \"object\","
			+ "    \"properties\": {"
			+ "      \"userId\": {"
			+ "        \"type\": \"string\","
			+ "        \"minLength\": 1,"
			+ "        \"description\": \"OE User Id for the requestor\""
			+ "      },"
			+ "      \"serviceId\": {"
			+ "        \"type\": \"string\","
			+ "        \"minLength\": 1,"
			...
			+ "        \"type\": \"string\","
			+ "        \"minLength\": 1,"
			+ "        \"description\": \"URI of the page being rated\""
			+ "      },"
			+ "      \"submissionDate\": {"
			+ "        \"type\": \"string\","
			+ "        \"format\": \"date-time\","
